...
static const int kvk_map_qwerty[][3] = {
  ...
  { 0x15, XK_4 ,XK_dollar },
  { 0x16, XK_6 ,XK_asciicircum },
  { 0x17, XK_5 ,XK_percent },
  { 0x18, XK_equal ,XK_plus },
  { 0x19, XK_9 ,XK_parenleft },
  { 0x1A, XK_7 ,XK_ampersand },
  { 0x1B, XK_minus ,XK_underscore },
  { 0x1C, XK_8 ,XK_asterisk },
  { 0x1D, XK_0 , XK_parenright },
  { 0x1E, XK_bracketright ,XK_braceright },
  { 0x1F, XK_o ,XK_O },
  { 0x20, XK_u ,XK_U },
